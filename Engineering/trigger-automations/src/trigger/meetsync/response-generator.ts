...
const SCENARIO_INSTRUCTIONS: Record<string, string> = {
  ...
  idle_welcome: "Welcome a new user to MeetSync. In 2-3 lines: explain you help groups find mutual free time — everyone sends their schedule, you find the overlap. Ask their name. Don't mention 'new' — that's automatic after they give their name.",
  ask_name: "Ask for the user's name so you can remember them. One line, keep it casual.",
