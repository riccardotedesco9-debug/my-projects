...
const SCENARIO_INSTRUCTIONS: Record<string, string> = {
  ...
  offer_outreach: "The partner isn't in the system yet. Ask the user if they want the bot to reach out to the partner directly via WhatsApp. Make it clear the bot will identify itself and mention who invited them. The user can also just tell their friend to message the bot.",
  outreach_sent: "Confirm that you've sent a message to the partner. Let the user know you'll notify them when the partner responds. Mention the partner might take some time.",
  proactive_intro: "This is the first message to someone who hasn't used the bot before. The bot is reaching out on behalf of someone who wants to schedule. Be friendly, transparent, identify as MeetSync bot, mention who sent the invite, and explain how to get started by replying. Keep it short — 3-4 lines max.",
...
const STATIC_FALLBACKS: Record<string, (ctx: ResponseContext) => string> = {
  ...
  offer_outreach: () => "I don't know them yet. Want me to message them directly on WhatsApp? Or you can tell them to message me.",
  outreach_sent: () => "Done! I've sent them a message. I'll let you know when they reply.",
  proactive_intro: (ctx) => `Hey! ${ctx.partnerName ?? "Someone"} wants to find a time to meet up with you. I'm MeetSync, a scheduling bot on WhatsApp. Reply to this message to get started!`,
