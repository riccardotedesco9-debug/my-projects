---
description: "💡💡 Create a production-ready video script with creative direction - Args: ['type] [topic']"
---
...
- If relevant, run `node .opencode/skills/brand-guidelines/scripts/inject-brand-context.cjs --json` and incorporate:
  - Tone of voice
