---
description: "Command: mkt-storage-upload"
---
...
2. Load s3-client from `.opencode/skills/storage/scripts/s3-client.cjs`
...
**Script Usage:**
```javascript
const s3 = require('./.opencode/skills/storage/scripts/s3-client.cjs');
