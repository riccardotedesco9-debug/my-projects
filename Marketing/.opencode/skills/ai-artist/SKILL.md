...
python3 .opencode/skills/ai-artist/scripts/search.py "<keywords>" --domain examples
...
```bash
python3 .opencode/skills/ai-artist/scripts/search.py "<query>" --domain <domain>
```
...
**Standard Option:**
```bash
python3 .opencode/skills/ai-artist/scripts/search.py "bento grid marketing" --domain examples
