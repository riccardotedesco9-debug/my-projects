...
| **Insights charts (build / refresh)** | Build/refresh the summary charts anchored to the right of the data. |
| **Show column filters** | Add filter dropdowns to every column (filter by depleted stock, status, category…). |
