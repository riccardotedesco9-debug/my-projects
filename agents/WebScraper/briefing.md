...
- Need custom art / video / music / voice? That's the **WebDesign / Marketing** domains — `creative-router` (fal) for visuals (+ AI-*fill* music), **Epidemic Sound** for licensed music/SFX, **ElevenLabs** for voice/SFX; add that `Domain:` to the project too rather than pulling the tools in here.
